    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2">
                ...
                <select class="form-control" wire:model.defer="searchCategoryGroupId" wire:change="changeCateogryGroup">
            ...
            <div class="col-md-2">
                ...
                <select class="form-control" wire:model.defer="searchCategoryId" wire:change="changeCateogry">
                    <option value="">All</option>
            ...
            <div class="col-md-3">
                ...
                <select class="form-control" wire:model.defer="searchSubCategoryId">
            ...
            <div class="col-md-3">
                ...
                <input type="text" placeholder="Generic Name" class="form-control" wire:model.defer="searchName">
            </div>
            ...
            <div class="col-12">
                <div class="dataTables_length" style="margin-bottom: 10px;">
                    ...
                    <h5 class="border-bottom" style="float:right">
                        <a class="btn btn-success btn_init_modal btn-sm" href="javascript:void(0)" data-toggle="modal" data-target="#genericFormModal"><i class="fa fa-plus"></i> Create New Generic</a>
                    </h5>
                </div>
...
<!-- Modal Start-->
<div wire:ignore.self class="modal fade" id="genericFormModal" tabindex="-1" role="dialog" aria-labelledby="genericFormModalTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 mb-3">
                        ...
                        <div>
                            <input type="text" maxlength="100" class="form-control ignoreSpecial @error('generic_name') is-invalid @enderror" wire:model.defer="generic_name" placeholder="" />
                            @error('generic_name')
                            <em class="error invalid-feedback">{{ $message }}</em>
                            @enderror
                        </div>
