...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <label>Dosage Route Name</label>
                <input type="text" placeholder="Dosage Route Name" class="form-control" wire:model.defer="searchDosageRouteName">
            </div>
            ...
            <div class="col-12">
                <div class="dataTables_length" style="margin-bottom: 10px;">
                    ...
                    <h5 class="border-bottom" style="float:right">
                        <a class="btn btn-success btn_init_modal btn-sm" href="javascript:void(0)" data-toggle="modal" data-target="#dosageRouteFormModal"><i class="fa fa-plus"></i> Dosage Route Add</a>
                    </h5>
                </div>
                    ...
                    <table class="table table-bordered dataTable dtr-inline">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->dosage_route_name}}</td>
                                <td>
                                    <livewire:active-status-component :model="$row" :key="$loop->iteration.time().'status'" />
                                </td>
                                <td>{{date('d/m/Y H:i:s', strtotime($row->created_at))}}</td>
                                <td>
                                    <button data-toggle="modal" data-target="#dosageRouteFormModal" wire:click="edit({{ $row->id }})" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></button>
...
<!-- Modal Start-->
<div wire:ignore.self class="modal fade" id="dosageRouteFormModal" tabindex="-1" role="dialog" aria-labelledby="supplierFormModalTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 col-sm-6 mb-3">
                        <label>Dosage Route Name <span class="req">*</span></label>
                        <div>
                            <input type="text" maxlength="100" class="form-control @error('dosage_route_name') is-invalid @enderror" wire:model.defer="dosage_route_name" placeholder="Dosage Route Name" />
                            @error('dosage_route_name')
